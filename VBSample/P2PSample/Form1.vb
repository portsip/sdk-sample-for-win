...
Public Partial Class Form1
	...
	Public Const MAX_LINES As Integer = 9
	' Maximum lines
    Public Const LINE_BASE As Integer = 1
    ...
    Function joinConference(ByVal index As Int32) As Integer
	...
	Private Sub Button1_Click(sender As Object, e As EventArgs)
		...
		If textBoxLocalPort.Text.Length <= 0 Then
			MessageBox.Show("The local SIP port does not allows empty.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
			Return
		End If

		Dim localSipPort As Integer = Integer.Parse(textBoxLocalPort.Text)
		If localSipPort <= 0 OrElse localSipPort > 65535 Then
			MessageBox.Show("The local SIP port out of range.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
			Return
		End If
...
'            
        ...
        Dim stunServer As String = [String].Empty
        Dim transport As TRANSPORT_TYPE = TRANSPORT_TYPE.TRANSPORT_UDP

        Dim ip As String = getLocalIP()

        ' Initialize the SDK
        Dim rt As Int32 = _sdkLib.initialize(transport, ip, localSipPort, PORTSIP_LOG_LEVEL.PORTSIP_LOG_NONE, logFilePath, MAX_LINES, agent, 0, 0, "/", "", False)
        ...
        Dim sipDomain As String = String.Empty
		Dim SIPServer As String = String.Empty
		Dim outboundServer As String = String.Empty
		Dim displayName As String = String.Empty
		Dim authName As String = String.Empty
        ...
        rt = _sdkLib.setUser(userName, displayName, authName, password, _
                            sipDomain, SIPServer, SIPServerPort, stunServer, 0, outboundServer, _
                            outboundServerPort)
		If rt <> 0 Then
			_sdkLib.unInitialize()
			_sdkLib.releaseCallbackHandlers()
	...
	Private Sub ComboBoxSRTP_SelectedIndexChanged(sender As Object, e As EventArgs)
		SetSRTPType()
	End Sub
	...
	Private Sub ComboBoxLines_SelectedIndexChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			ComboBoxLines.SelectedIndex = 0
			Return
		End If
	...
	Private Sub ButtonDial_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
		...
		If callTo.IndexOf("sip:") = -1 OrElse callTo.IndexOf("@") = -1 Then
			MessageBox.Show("The phone number must likes: sip:123456@192.168.1.111.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
			Return
		End If
		...
		Dim sessionId As Integer = _sdkLib.[call](callTo, hasSdp, checkBoxMakeVideoCall.Checked)
		If sessionId <= 0 Then
	...
	Private Sub ButtonHangUp_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ButtonAnswer_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ButtonReject_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ButtonHold_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ButtonTransfer_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub CheckBoxConf_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
        ...
        If CheckBoxConf.Checked = True Then
            Dim rt As Integer = _sdkLib.createVideoConference(remoteVideoPanel.Handle, width, height, True)
            If rt = 0 Then
        ...
        Else
            ...
            Dim sessionIds As Integer() = New Integer(8) {0, 0, 0, 0, 0, 0, _
             0, 0, 0}
            For i As Integer = LINE_BASE To MAX_LINES - 1
	...
	Private Sub TrackBarSpeaker_ValueChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub TrackBarMicrophone_ValueChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub CheckBoxMute_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ComboBoxMicrophones_SelectedIndexChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ComboBoxSpeakers_SelectedIndexChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ComboBoxVideoResolution_SelectedIndexChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub TrackBarVideoQuality_ValueChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ButtonCameraOptions_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
		...
		If rt <> 0 Then
			MessageBox.Show("Get camera name failed.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
			Return
		End If

		rt = _sdkLib.showVideoCaptureSettingsDialogBox(uniqueId.ToString(), uniqueId.Length, "Camera settings", Handle, 200, 200)
		If rt <> 0 Then
			MessageBox.Show("Failed to show the camera settings dialog.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
			Return
		End If

	End Sub

	Private Sub ButtonLocalVideo_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub ButtonSendVideo_Click(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub checkBoxPRACK_CheckedChanged(sender As Object, e As EventArgs)
		updatePrackSetting()
	End Sub

	Private Sub CheckBoxDND_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub checkBoxPCMU_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub checkBoxPCMA_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub checkBoxG729_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub checkBoxILBC_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub checkBoxGSM_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub checkBoxAMR_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub


	Private Sub CheckBoxG722_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub CheckBoxG7221_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub CheckBoxAMRwb_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub CheckBoxSpeexWB_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub CheckBoxSpeex_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub

	Private Sub checkBoxOpus_CheckedChanged(sender As Object, e As EventArgs)
		UpdateAudioCodecs()
	End Sub


	Private Sub checkBoxH263_CheckedChanged(sender As Object, e As EventArgs)
		UpdateVideoCodecs()
	End Sub

	Private Sub checkBoxH2631998_CheckedChanged(sender As Object, e As EventArgs)
		UpdateVideoCodecs()
	End Sub

	Private Sub checkBoxH264_CheckedChanged(sender As Object, e As EventArgs)
		UpdateVideoCodecs()
	End Sub

	Private Sub checkBoxVP8_CheckedChanged(sender As Object, e As EventArgs)
		UpdateVideoCodecs()
	End Sub


	Private Sub checkBoxAEC_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
        End If
	...
	Private Sub checkBoxVAD_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub checkBoxCNG_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
		End If
	...
	Private Sub checkBoxAGC_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
        End If
	...
	Private Sub checkBoxANS_CheckedChanged(sender As Object, e As EventArgs)
		If _SIPInited = False Then
			Return
        End If
	...
	Private Sub checkBox1_CheckedChanged(sender As Object, e As EventArgs)
		...
		If checkBox1.Checked = True Then
			...
			If rt <> 0 Then
				MessageBox.Show("Enable the audio stream callback failure.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
	...
	Private Sub Button21_Click(sender As Object, e As EventArgs)
		...
		Dim playFile As String = TextBoxPlayFile.Text
		_sdkLib.playAudioFileToRemote(_CallSessions(_CurrentlyLine).getSessionId(), playFile, 16000, False)
    ...
    Public Function onRegisterSuccess(callbackIndex As Int32, callbackObject As Int32, statusText As [String], statusCode As Int32, sipMessage As StringBuilder) As Int32 Implements SIPCallbackEvents.onRegisterSuccess
        ' For P2P mode, do not need to process register events.
    ...
    Public Function onInviteIncoming(ByVal callbackIndex As Int32, ByVal callbackObject As Int32, ByVal sessionId As Int32, ByVal callerDisplayName As [String], ByVal caller As [String], ByVal calleeDisplayName As [String],
     ...
     ByVal existsAudio As [Boolean], ByVal existsVideo As [Boolean], ByVal sipMessage As StringBuilder) As Int32 Implements SIPCallbackEvents.onInviteIncoming
        ...
        Dim answerVideoCall As [Boolean] = False
        ListBoxSIPLog.Invoke(New MethodInvoker(Function() _
              AA = CheckBoxAA.Checked))

        ListBoxSIPLog.Invoke(New MethodInvoker(Function() _
        answerVideoCall = checkBoxAnswerVideo.Checked))
        ...
        If needIgnoreAutoAnswer = False AndAlso AA = True Then
            ...
            _sdkLib.answerCall(_CallSessions(index).getSessionId(), answerVideoCall)
    ...
    Public Function onInviteFailure(ByVal callbackIndex As Int32, ByVal callbackObject As Int32, ByVal sessionId As Int32, ByVal reason As [String], ByVal code As Int32, sipMessage As StringBuilder) As Int32 Implements SIPCallbackEvents.onInviteFailure
    ...
    Public Function onInviteBeginingForward(ByVal callbackIndex As Int32, ByVal callbackObject As Int32, ByVal forwardTo As [String]) As Int32 Implements SIPCallbackEvents.onInviteBeginingForward
        Dim Text As String = "Call has been forwarded to: "
        Text = Text & forwardTo
    ...
    Public Function onPlayVideoFileFinished(ByVal callbackIndex As Int32, ByVal callbackObject As Int32, ByVal sessionId As Int32) As Int32 Implements SIPCallbackEvents.onPlayVideoFileFinished
        ...
        Dim Text As String = "Play video end on line: "
        Text += i.ToString()
