...
typedef enum
{
	...
	FILEFORMAT_WAVE_STEREO,	///<	The record audio file is in WAVE Stereo format.
	FILEFORMAT_CALLBACK,    ///<	The callback the audio stream for video recorder. Only for SDK internal use.
}AUDIO_FILE_FORMAT;
